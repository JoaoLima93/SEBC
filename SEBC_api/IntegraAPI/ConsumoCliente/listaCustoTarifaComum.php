...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    $sql = "SELECT cc.id                            as id_cliente,
                   c_now.custo_tarifa_normal        as custo_atual, 
                   sum(c_dia.custo_tarifa_normal)   as custo_dia,
                   sum(c_mes.custo_tarifa_normal)   as custo_mes
    ...
    if ($result->num_rows > 0) {   
        while($row = mysqli_fetch_assoc($result)) {    
              ...
              $rows['custos'][] = array('id_cliente'      => $id_cliente,
